...
describe MessagesController do
  ...
  let(:valid_attributes) { { "message_type" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update).with({ "message_type" => "MyString" })
        put :update, {:id => message.to_param, :message => { "message_type" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the message as @message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Message.any_instance.stub(:save).and_return(false)
        put :update, {:id => message.to_param, :message => { "message_type" => "invalid value" }}, valid_session
        assigns(:message).should eq(message)
      end
